...
def parse_cmd_options(argv):
    ...
    parser.add_argument('--no_acc_eval', action='store_true', help='Only training.')
    ...
    parser.add_argument('--gpu_multi_gpus', default='0,1', type=str, help='assign multi-gpus by comma concat')
    ...
    parser.add_argument('--freeze_backbone', action='store_true', help='freeze_backbone.')
    parser.add_argument('--only_backbone', action='store_true', help='load backbone.')

    parser.add_argument('--start_epoch', default=0, type=int, help='manual epoch number (useful on restarts)')
    parser.add_argument('--epochs', default=90, type=int, metavar='N', help='number of total epochs to run')
    parser.add_argument('--save_dir', default=None, type=str, help='where to save models.')
    parser.add_argument('--save_freq', default=1, type=int, help='How many epochs to save a model.')
    parser.add_argument('--print_freq', default=1000, type=int, help='print frequency (default: 100)')
    ...
    parser.add_argument('--suploss', action='store_true')
    ...
    parser.add_argument('--auto_augment_type', type=str, default=None, help='type of auto_augment CIFA or imagenet')
    parser.add_argument('--shuffle_train_data',  action='store_true', help='shuffle sample data')
    ...
    parser.add_argument('--add_margin', action='store_true', help='Help to add margin into model.')
    parser.add_argument('--metric', type=str, default=None, help='metric in [add_margin, arc_margin, sphere]')
